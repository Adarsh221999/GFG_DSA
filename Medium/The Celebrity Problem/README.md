<h2><a href="https://practice.geeksforgeeks.org/problems/the-celebrity-problem/1?page=3&category=Arrays,Tree&sortBy=submissions">The Celebrity Problem</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">A celebrity is a person who is known to all but does not know anyone at a party. If you go to a party of N people, find if there is a celebrity in the party or not.<br>
